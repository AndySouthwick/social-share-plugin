jQuery(document).ready( function($) {
    ...
    function updateShare(){
       ...
       if(datafixstring){
         ...
         .attr("data-link",  loc + "?associate=" + datafixstring + '&source=twitter');
         $("#myBtn #gl,#popup-share-links #gl").attr("href", "https://plus.google.com/share?url=" + loc + variabelstring + datafixstring + '&source=googleplus');
